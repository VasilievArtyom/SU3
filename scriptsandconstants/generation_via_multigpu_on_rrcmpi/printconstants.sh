...
echo ${m_sa}
echo "${projpath}/approx_files/InvFourthRoot.txt"
echo "${projpath}/approx_files/InvFourthRoot_fine.txt"
echo "${projpath}/approx_files/EighthRoot.txt"
...
echo '1'
echo "${projpath}/approx_files/InvSqrRoot.txt"
echo "${projpath}/approx_files/InvSqrRoot_fine.txt"
echo "${projpath}/approx_files/FourthRoot.txt"
